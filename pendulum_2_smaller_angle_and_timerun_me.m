...
%% Initial Conditions
extForce_case = 'noExtForce';
switch extForce_case
    case 'noExtForce'
        % Use a very small initial angle
        theta_initial = ones(n, 1) * (0.01); % SMALL Initial angles
        omega_initial = zeros(n, 1);
        C = 0;
        omega_0 = 0;
    case 'extForce'
        theta_initial = zeros(n,1);
        omega_initial = zeros(n,1);
        C = .5;
        omega_0 = nf+0.1;
end
